...
let s:red_g = '#e06c75'
let s:red_c = 168
let s:none = ['NONE', 'NONE', 'NONE', 'NONE']


let g:airline#themes#transparentairlinetheme#palette = {}
...
let s:normal_inner = s:none
let s:normal_inner_modified = [s:yellow_g, s:med_lo_g, s:yellow_c, s:med_lo_c]
let g:airline#themes#transparentairlinetheme#palette.normal = 
    \ airline#themes#generate_color_map(s:normal_outer, s:normal_middle, s:normal_inner)
let g:airline#themes#transparentairlinetheme#palette.normal_modified =
...
let g:airline#themes#transparentairlinetheme#palette.insert = 
    \ airline#themes#generate_color_map(s:insert_outer, s:insert_middle, s:insert_inner)
let g:airline#themes#transparentairlinetheme#palette.insert_modified = 
    \ copy(g:airline#themes#transparentairlinetheme#palette.normal_modified)
...
let g:airline#themes#transparentairlinetheme#palette.replace =
    \ airline#themes#generate_color_map(s:replace_outer, s:replace_middle, s:replace_inner)
let g:airline#themes#transparentairlinetheme#palette.replace_modified = 
    \ copy(g:airline#themes#transparentairlinetheme#palette.insert_modified)
...
let g:airline#themes#transparentairlinetheme#palette.visual = 
    \ airline#themes#generate_color_map(s:visual_outer, s:visual_middle, s:visual_inner)
let g:airline#themes#transparentairlinetheme#palette.visual_modified = 
    \ copy(g:airline#themes#transparentairlinetheme#palette.insert_modified)


" Inactive window
" let s:inactive = [s:light_g, s:med_lo_g, s:light_c, s:med_lo_c]
let s:inactive = s:none
let s:inactive_modified = [s:yellow_g, '', s:yellow_c, '']
let g:airline#themes#transparentairlinetheme#palette.inactive = 
    \ airline#themes#generate_color_map(s:inactive, s:inactive, s:inactive)
let g:airline#themes#transparentairlinetheme#palette.inactive_modified = 
